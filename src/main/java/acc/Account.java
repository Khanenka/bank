...
//        int bankId = 0;
//         String sqlAccByPin = "SELECT * FROM accounts AS a INNER JOIN Bank AS b ON a.BankId = b.IdBank where AccountNumber = " + accountNumber + " AND PinCode = " + pinCode;
...
//        account.setBalance(BigDecimal.valueOf(bankId));
//
//
//        return account;
//    }
